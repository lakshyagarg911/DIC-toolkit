...
class ParamsPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._sp_radius = spin(5, 100, params.subset_radius, 5)
        ...
        self._sp_strain = spin(3, 60, params.strain_window, 1)
        right_lay.addLayout(_param_row(
        ...
        self._sp_tol = dspin(1e-6, 0.01, params.conv_tol, 1e-5, 5)
        right_lay.addLayout(_param_row(
            "Convergence tol", "Weighted-norm convergence threshold.",
            self._sp_tol, ""))

        self._sp_cutoff = dspin(0.0, 1.0, params.corr_cutoff, 0.05, 2)
        right_lay.addLayout(_param_row(
        ...
        self._sp_search = spin(5, 200, params.search_radius, 5)
        right_lay.addLayout(_param_row(
